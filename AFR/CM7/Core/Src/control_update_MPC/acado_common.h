 ...
 * 
 *  Matrix containing 4 differential variable vectors.
 */
real_t x[ 16 ];

/** Matrix of size: 3 x 4 (row major format)
 * 
 *  Matrix containing 3 control variable vectors.
 */
real_t u[ 12 ];

/** Matrix of size: 4 x 13 (row major format)
 * 
 *  Matrix containing 4 online data vectors.
 */
real_t od[ 52 ];

/** Column vector of size: 36
 * 
 *  Matrix containing 3 reference/measurement vectors of size 12 for first 3 nodes.
 */
real_t y[ 36 ];

/** Column vector of size: 4
 * 
 *  Reference/measurement vector for the 4. node.
 */
real_t yN[ 4 ];
 ...
 *
 *  \param strategy Shifting strategy: 1. Initialize node 4 with xEnd. 2. Initialize node 4 by forward simulation.
